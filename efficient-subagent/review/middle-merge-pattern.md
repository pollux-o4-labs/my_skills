...
> main commit history 오염 + 사장이 회귀 발견자 되는 패턴 직접 차단 목적.
> 사장 확정 사항 기반 정리. 본 파일은 SKILL.md 반영 전 review draft.
...
- 사장(운영자)이 회귀 발견자가 되는 패턴 반복 (CLAUDE.md 작업 규칙 12번 근본 동기)
...
_이 파일은 review draft — 사장 검토 후 SKILL.md 반영 여부 결정._
