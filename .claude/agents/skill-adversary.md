...
3. STANDARDS COMPLIANCE — independently verify every budgeted quantity against the caps in `./skillify-session-lessons/authoring-standards.md`, plus AIL frontmatter and section shape.
