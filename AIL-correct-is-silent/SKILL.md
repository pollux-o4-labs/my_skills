...
**Explicit user override**: if the user knowingly wants the history left inline, comply and note once that the durable record still belongs in the commit/ADR — a one-line transparency delta, not a refusal.
