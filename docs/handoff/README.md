...
- docs-handoff-index-bluf-retrofit — 이 파일의 기존 인덱스 줄 3건이 `docs/rules/01-index-line-bluf-discipline.md` 위반 — retrofit-on-edit 정책상 각 줄이 다음에 갱신될 때 정리, 별도 착수 불요 — 2026-07-16
